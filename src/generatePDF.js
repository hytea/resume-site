window.generatePDF = async () => {
  try {
    ...
    const parseHTMLAndAddToPDF = (doc, htmlContent, startX, startY) => {
    ...
    alert('Unable to generate PDF. Please try again or contact support if the problem persists.');
  }
};
